"""
Django settings for ironhackrepo project.
...
SECRET_KEY = "django-insecure-2j+a95ta&a3_uug0(^@9f3^4bq=*fa7xb5bmu0&lz05sxo@am^"
...
WSGI_APPLICATION = "ironhackrepo.wsgi.application"
...
STATICFILES_DIRS = [os.path.join(BASE_DIR,'ihrepo/static'),]
